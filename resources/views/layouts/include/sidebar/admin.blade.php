<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <ul id="components-nav"
                ...
                <li>
                    <a href="{{ route('admin.product.index') }}"
                        class="{{ request()->routeIs('admin.product.*', 'admin.product.gallery.index') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('admin.transection.*', 'admin.my-transection.*') ? '' : 'collapsed' }} "
            ...
            <ul id="transaction-nav"
                class="nav-content collapse {{ request()->routeIs('admin.transection.*', 'admin.my-transection.*') ? 'show' : '' }} "
                data-bs-parent="#sidebar-nav">
                <li>
