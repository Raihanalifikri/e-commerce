...
@section('content')
                ...
                <div class="slider">
                    <div class="thumbnail">
                        @foreach ($product->product_galleries as $item)
                            <div class="px-2">
                                <div class="item {{ $item->exists() ? url('storage/product/gallery', $item->image) : '' }}">
    ...
    <section class="bg-gray-100 px-4 py-16">
        <div class="container mx-auto">
            ...
            <div class="flex flex-wrap justify-between overflow-x-auto mb-4 -mx-3">
                @foreach ($recommendation as $row)
                    <div class="px-3 flex-none mb-4" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-red-200">
