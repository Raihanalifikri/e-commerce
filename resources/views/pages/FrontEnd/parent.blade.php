                ...
                <div class="w-auto">
                    <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                        ...
                        @if (Route::has('login'))
                            ...
                            @else
                                <li class="mx-3 rounded bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-xl px-3 text-black py-1 inline-block flex-none transition duration-200 ">
                                  <a href="{{ route('login') }}"
