        ...
        <form action="{{ route('admin.category.update', $row->id) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              ...
              <div class="col-12">
                  ...
                  <input type="file" class="form-control" id="categoryImage" name="image" value="{{ $row->image }}">
              </div>
              <div class="col-12">
                  <img src="#" alt="Category-image" id="preview-logo" class="visually-hiiden img-thumbnail">
              </div>
          </div>
